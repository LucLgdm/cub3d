...
/*   Updated: 2025/07/01 09:57:05 by lde-merc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_image_vilain(void *mlx, t_tex *vilain)
{
	...
	game->image_resized->vilain.addr = mlx_get_data_addr(game->image_resized->vilain.img,
...
void	ft_image_vilain_2(void *mlx, t_tex *vilain)
{
	...
	game->image_resized->vilain_2.addr = mlx_get_data_addr(game->image_resized->vilain_2.img,
...
void	ft_image_vilain_3(void *mlx, t_tex *vilain)
{
	...
	game->image_resized->vilain_3.addr = mlx_get_data_addr(game->image_resized->vilain_3.img,
